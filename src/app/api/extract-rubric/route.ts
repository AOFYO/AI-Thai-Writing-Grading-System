...
กฎเหล็กในการสร้าง "description", "raw_score" และ "weight":
1. raw_score คือคะแนนดิบสูงสุดของระดับคะแนนในตาราง (เช่น 5)
2. weight คือน้ำหนักของหัวข้อนั้น (หากไม่มีระบุให้มีค่าเป็น 1)
3. max_score ต้องมีค่าเท่ากับ raw_score x weight เสมอ
4. ในฟิลด์ "description" ของแต่ละ criteria คุณต้องรวบรวมข้อมูลต่อไปนี้ทั้งหมดมาเรียบเรียงเป็นคำสั่ง:
